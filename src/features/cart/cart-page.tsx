...
export function CartPage() {
    ...
    return (
      <div className="container-page">
        <EmptyState
          ...
          description="The collection is waiting. Add a piece and we will keep it here until you are ready."
          action={
            <Button asChild>
  ...
  return (
    <div className="container-page py-8 md:py-12">
      ...
      <p className="mt-2 text-small">{items.length} {items.length === 1 ? 'piece' : 'pieces'}</p>
